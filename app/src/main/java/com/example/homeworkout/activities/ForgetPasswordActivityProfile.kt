...
import com.example.homeworkout.databinding.ActivityForgetPasswordProfileBinding
import com.google.firebase.auth.FirebaseAuth

class ForgetPasswordActivityProfile : AppCompatActivity() {

    private lateinit var binding: ActivityForgetPasswordProfileBinding
    lateinit var firebaseAuth: FirebaseAuth
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityForgetPasswordProfileBinding.inflate(layoutInflater)
